...
const { resolved, rejected, withdrawnByApplicant, discardedByApplicant } = require('../flow/status');
...
function queryBuilder({ profile, sort = { column: 'updatedAt' }, limit, offset, filters, progress = 'outstanding' }) {
...
queryBuilder.getSubjectTasks = profileId => {
  return Case.query()
