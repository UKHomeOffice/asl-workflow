...
flow[newCase.id] = [autoResolved, withNtco, withAdmin, withInspectorate, withLicensing];
...
flow[withAdmin.id] = [adminEndorsed, returnedToApplicant];
flow[adminEndorsed.id] = [withInspectorate];
