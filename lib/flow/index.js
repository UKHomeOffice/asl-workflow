...
flow[withLicensing] = [returnedToApplicant, referredToInspector, rejected, resolved];
flow[ntcoEndorsed] = [returnedToApplicant, referredToInspector, rejected, resolved];
flow[inspectorRecommended] = [returnedToApplicant, rejected, resolved];
