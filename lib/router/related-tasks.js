...
module.exports = taskflow => {
  ...
  const relatedTasksQuery = ({ user, model, modelId, action, establishmentId, onlyOpen, sort = { column: 'updatedAt' }, limit, offset }) => {
    ...
    if (establishmentId) {
      query.andWhere(builder => {
        builder
          .whereJsonSubsetOf('data:model', ['profile', 'trainingPil'])
