...
const { resubmitted, autoResolved, resolved, returnedToApplicant } = require('./flow/status');
...
const hooks = {
  ...
  withdraw: require('./hooks/withdraw')
};
...
module.exports = settings => {
  ...
  flow.hook('pre-status:*:updated', hooks.update(settings));
  ...
  flow.hook(`status:*:withdrawn-by-applicant`, hooks.withdraw(settings));
