...
describe('Establishment reinstate', () => {
  before(() => {
  ...
  it('external users cannot reinstate an establishment', () => {
  ...
  it('licensing cannot reinstate an establishment', () => {
  ...
  it('inspectors can reinstate an establishment', () => {
